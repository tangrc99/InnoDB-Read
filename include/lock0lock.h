...
/** this flag denotes an ordinary next-key lock in contrast to LOCK_GAP or
 LOCK_REC_NOT_GAP */
constexpr uint32_t LOCK_ORDINARY = 0; /* 记录本身加记录后的区间 */
...
constexpr uint32_t LOCK_GAP = 512; /* 记录前的区间 */
...
constexpr uint32_t LOCK_REC_NOT_GAP = 1024; /* 记录本身 */
...
constexpr uint32_t LOCK_INSERT_INTENTION = 2048; /* 意向锁 */
/** Predicate lock */
constexpr uint32_t LOCK_PREDICATE = 8192; /* 用来锁定一个空间 */
/** Page lock */
